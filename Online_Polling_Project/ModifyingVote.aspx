<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModifyingVote.aspx.cs" Inherits="Online_Polling_Project.ModifyingVote" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <h3>投票人身分
                <asp:CheckBoxList ID="CheckBoxList1" runat="server" OnSelectedIndexChanged="PermissionSelection_Change" AutoPostBack="true">
            ...
            <asp:Button ID="BuildButton" runat="server" Text="確定修改" OnClick="BuildClick"  height="50" width="100"/><br />
